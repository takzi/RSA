 ...
 class DB{
	...
	function getHolidayDatesForCongregation($_congregation){
		try{
			...
			echo "getHolidayDatesForCongregation - ".$e->getMessage();
			die();
		}
		return $data;
	}
	...
	function getCongregationsHolidaysForDates($_start,$_end){
		try{
			...
			echo "getCongregationsHolidaysForDates - ".$e->getMessage();
			die();
		}
		return $data;
	}
	...
	function insertNewHoliday($_name, $_date, $_congregation=""){
		try{
			...
			echo "insertNewHoliday - ".$e->getMessage();
			die();
		}
	}
	...
	function deleteHoliday($_name, $_date){
		try{
			...
			echo "deleteHoliday - ".$e->getMessage();
			die();
		}
	}
	...
	function getAllBlackoutDates(){
		try{
			...
			echo "getAllBlackoutDates - ".$e->getMessage();
			die();
		}
		return $data;
	}
	...
	function updateBlackoutdate($_congregationID,$_blackoutDateFrom,$_blackoutDateTo){
		try{
			...
			echo "updateBlackoutdate - ".$e->getMessage();
			die();
		}
	}
	...
	function deleteBlackoutdate($_congregationID,$_blackoutDateTo,$_blackoutDateFrom){
		try{
			...
			echo "deleteBlackoutdate - ".$e->getMessage();
			die();
		}
	}
	...
	function updateAvailability($_busDriverID,$_availability,
		...
		try{
			...
			echo "updateAvailability - ".$e->getMessage();
			die();
		}
	}
	...
	function deleteAvailability($_availability,$_busDriverID){
		try{
			...
			echo "deleteAvailability - ".$e->getMessage();
			die();
		}
	}
