...
class AdminFunctions{
	...
	private function getHTMLSnippet($id, $name, $type){
		return "<tr>
					<td>" . $name ." <a href='admin_edit_". $this->getType($type, 'cong', 'bus','user') . ".php?" . $this->getType($type, 'congregation', 'driver', 'user') . "=" . $id ."'><input type='button' class='tb_right1' name='" . $name . "' value='Edit'></a><a href=\"#\"><input type='resetButton' class='tb_right2' value='Reset Password'></a><a href=\"#\"><input type='deleteButton' class='tb_right3' value='Delete'></a></td>
				</tr>";
	}	
